...
#define _nstates3	19	/* entorno */
#define minseq3	60
#define maxseq3	77
#define _endstate3	18

#define _nstates2	30	/* fsm_temperatura */
#define minseq2	31
#define maxseq2	59
#define _endstate2	29

#define _nstates1	12	/* fsm_mediciones */
#define minseq1	20
#define maxseq1	30
#define _endstate1	11

#define _nstates0	21	/* fsm_luz */
#define minseq0	0
#define maxseq0	19
...
#define Pfsm_temperatura	((P2 *)this)
typedef struct P2 { /* fsm_temperatura */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfsm_mediciones	((P1 *)this)
typedef struct P1 { /* fsm_mediciones */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	unsigned lumAlta : 1;
	unsigned lim_reached : 1;
	unsigned colder_temp : 1;
	unsigned sensor_timeout : 1;
	uchar state;
	uchar m_state;
	uchar t_state;
#ifdef TRIX
